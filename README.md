...
|---------------|--------|--------|--------|
| **PenTest+** | CompTIA | Penetration Testing | ✅ Active |
| **CySA+** | CompTIA | Cybersecurity Analysis | ✅ Active |
| **Security+** | CompTIA | Security Fundamentals | ✅ Active |
| **Network+** | CompTIA | Networking | ✅ Active |
